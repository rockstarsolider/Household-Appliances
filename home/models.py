...
class WebsiteSetting(models.Model):
    ...
    logo = models.ImageField(null=True, blank=True, verbose_name='لوگوی وبسایت')
    banner_1 = models.ImageField(null=True, blank=True, verbose_name='بنر شماره 1')
    banner_2 = models.ImageField(null=True, blank=True, verbose_name='بنر شماره 2')
    banner_3 = models.ImageField(null=True, blank=True, verbose_name='بنر شماره 3')
