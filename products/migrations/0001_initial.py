    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('special_price', models.PositiveBigIntegerField(blank=True, null=True)),
                ('image', models.ImageField(default='default.png', upload_to='products/')),
                ('stock', models.PositiveIntegerField(default=0)),
                ('published_at', models.DateTimeField()),
                ('properties', models.TextField(blank=True, help_text="Enter properties in the format 'key: value' on separate lines.")),
